...
class PDFController extends BaseController
{
    ...
    {   $pembayaran = new PembayaranModel();
        ...
        $data['transaksi'] = $transaksi->PilihTransaksi($no_transaksi)->getRow();
        ...
        $pdf->SetAuthor('MyHotle.com');
        $pdf->SetTitle('PDF MyHotle.com');
       ...
       //view mengarah ke invoice.php
        ...
        // This method has several options, check the source code documentation for more information.
        $pdf->Output('Transaksi-pos-MyHotle.pdf', 'I');
